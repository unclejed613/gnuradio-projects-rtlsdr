...
# Title: MULTIMODE-RADIO
# Author: JED MARTIN
# Description: AM-FM-SSB RECEIVER FOR RTL-SDR
# Generated: Sun Jan 15 22:23:55 2017
##################################################
...
class multimode_radio(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "MULTIMODE-RADIO")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("MULTIMODE-RADIO")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "multimode_radio")
        ...
        self.msel = msel = 1
        self.gain = gain = 35
        self.freq = freq = fhun+ften+fone+fsel-100000
        self.corr = corr = 0
        self.FREQUENCY = FREQUENCY = (fhun+ften+fone+fsel)/1000000

        ##################################################
        # Blocks
        ##################################################
        self._squelch_range = Range(-80, -20, 1, -70, 200)
        ...
        self.rtlsdr_source_0.set_freq_corr(corr, 0)
        ...
        self._fsel_range = Range(0, 995000, 5000, 0, 1000)
    ...
    def set_ften(self, ften):
        self.ften = ften
        self.set_FREQUENCY(self._FREQUENCY_formatter((self.fhun+self.ften+self.fone+self.fsel)/1000000))
        self.set_freq(self.fhun+self.ften+self.fone+self.fsel-100000)
    ...
    def set_corr(self, corr):
        self.corr = corr
        self.rtlsdr_source_0.set_freq_corr(self.corr, 0)
...
def main(top_block_cls=multimode_radio, options=None):
